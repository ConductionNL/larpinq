...
/**
 * Character entity for LarpingApp
 *
 * @category  Entity
...
/**
 * Entity representing a Character in the LARP game.
 *
...
class Character extends Entity implements JsonSerializable
{
     ...
     * @return void
     *
     * @psalm-suppress PossiblyUnusedMethod Called from CharacterMapper::createFromArray and updateFromArray.
     */
