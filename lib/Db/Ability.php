...
/**
 * Entity representing an Ability in the LARP game.
 *
...
class Ability extends Entity implements JsonSerializable
{
     ...
     * @return void
     *
     * @psalm-suppress PossiblyUnusedMethod Called from AbilityMapper::createFromArray and updateFromArray.
     */
