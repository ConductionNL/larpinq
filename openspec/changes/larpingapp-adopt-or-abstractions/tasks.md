...
- [~] 1.5 [DEFERRED — needs live instance] Verify — deferred to downstream cycle (handoff)
...
- [~] 3.1 [DEFERRED] `src/composables/orClient.js` — superseded by the — deferred to downstream cycle (handoff)
  library-owned `createObjectStore`; the param/header belong there.
- [~] 3.2 [DEFERRED] `?_lang={locale}` on fetches — needs OR API support. — deferred to downstream cycle (handoff)
- [~] 3.3 [DEFERRED] `X-Translation-Target-Language` on writes — needs OR — deferred to downstream cycle (handoff)
  API support.
- [~] 3.4 [DEFERRED] Store migration — N/A; single shared object store — deferred to downstream cycle (handoff)
  already owns fetches.
- [~] 3.5 [DEFERRED] "(translated from {lang})" badge — needs — deferred to downstream cycle (handoff)
  `sourceLanguage` metadata from OR (unmerged).
- [~] 3.6 [DEFERRED] e2e for the badge — depends on 3.5. — deferred to downstream cycle (handoff)
...
- [~] 4.1 [DEFERRED] peer constraint on the `useTenantContext` version. — deferred to downstream cycle (handoff)
- [~] 4.2 [DEFERRED] index-view tenant-switch refetch. — deferred to downstream cycle (handoff)
- [~] 4.3 [DEFERRED] detail-view navigate-back on tenant switch. — deferred to downstream cycle (handoff)
- [~] 4.4 [DEFERRED] `X-OpenRegister-Organisation` write stamping. — deferred to downstream cycle (handoff)
- [~] 4.5 [DEFERRED] e2e tenant-switch refetch. — deferred to downstream cycle (handoff)
...
- [~] 5.2 [DEFERRED — follow-up change] Open — deferred to downstream cycle (handoff)
...
- [~] 6.2 [DEFERRED] `docs/features/character-management.md` badge — deferred to downstream cycle (handoff)
...
- [~] 7.5 [DEFERRED] i18n / tenant-switch e2e — depends on Phases 3/4. — deferred to downstream cycle (handoff)
- [~] 7.6 [DEFERRED — needs live instance] Manual smoke on a clean dev — deferred to downstream cycle (handoff)
  Nextcloud.
