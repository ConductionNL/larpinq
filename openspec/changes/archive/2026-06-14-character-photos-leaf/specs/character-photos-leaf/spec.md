...
# Character Photos via Photos Leaf

## Purpose

Offer portrait / reference images on the Character detail page by consuming the
OpenRegister photos integration leaf (built on the OR files /
object-interactions abstraction), per ADR-019 + ADR-022, instead of adding a
bespoke image field to the Character schema.
