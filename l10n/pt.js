OC.L10N.register(
    "larpinq",
    {
        ...
        "Example data fills the lists, detail pages and dashboards so you can see the app working straight away. Pick \"None\" on a production install.": "Os dados de exemplo preenchem as listas, as páginas de detalhe e os painéis, para ver a aplicação a funcionar de imediato. Escolha \"Nenhum\" numa instalação de produção.",
        "Load the example data": "Carregar os dados de exemplo",
        "Loads what you picked. The data is obviously sample data, it is safe to run more than once, and you can delete it afterwards.": "Carrega o que escolheu. São claramente dados de exemplo, a operação pode repetir-se sem risco e pode apagá-los depois.",
        "None, I will set this up myself": "Nenhum, eu próprio configuro isto",
        "Nothing is imported. You start with an empty app and add your own data.": "Nada é importado. Começa com uma aplicação vazia e acrescenta os seus próprios dados.",
        "Example data": "Dados de exemplo",
        "Sample values for every schema this app supplies, generated from the schemas themselves. It shows the lists, detail pages and dashboards working rather than telling a story. Safe to run more than once, and you can delete it afterwards.": "Valores de exemplo para cada esquema que esta aplicação fornece, gerados a partir dos próprios esquemas. Mostram as listas, as páginas de detalhe e os painéis a funcionar em vez de contarem uma história. Repetível sem risco e apagável depois.",
        "Larpinq": "Larpinq",
        "Dashboard": "Painel",
        ...
        "Are you sure you want to delete this?": "Tem a certeza de que pretende eliminar isto?",
        "Download PDF": "Transferir PDF",
        "Select a template to generate a PDF from this character": "Selecione um modelo para gerar um PDF a partir deste personagem",
        "PDF generation requires the DocuDesk app to be installed and enabled": "A geração de PDF requer que a aplicação DocuDesk esteja instalada e ativada",
        ...
        "Configure OpenRegister data source to enable this widget": "Configure a fonte de dados OpenRegister para ativar este widget",
        "Loading skill data...": "A carregar dados de habilidades...",
        "Retry": "Tentar novamente",
        "No skill data available": "Não há dados de habilidades disponíveis",
        "characters": "personagens",
        "Other": "Outro",
        "Failed to load skill data": "Falha ao carregar dados de habilidades",
        "Data storage": "Armazenamento de dados",
        "Configure where to store your LARP data": "Configure onde armazenar os seus dados de LARP",
        "Open Register is not installed. Some features might be unavailable.": "O Open Register não está instalado. Algumas funcionalidades podem estar indisponíveis.",
        "Source": "Fonte",
        "Register": "Registo",
        "Schema": "Esquema",
        "Internal": "Interno",
        ...
        "No events yet": "Ainda não há eventos",
        "View all ({count})": "Ver todos ({count})",
        "Recent characters": "Personagens recentes",
        "Recent events": "Eventos recentes",
        "Skill usage by characters": "Utilização de habilidades por personagens",
        "Refresh dashboard": "Atualizar painel",
        "Larpinq settings": "Definições do Larpinq",
        "Configure your Larpinq installation": "Configure a sua instalação do Larpinq",
        "Version information": "Informações da versão",
        "Information about the current Larpinq installation": "Informações sobre a instalação atual do Larpinq",
        "Support": "Suporte",
        ...
        "Re-import failed": "A reimportação falhou",
        "Configuration": "Configuração",
        "OpenRegister is not configured. Some features may be limited.": "O OpenRegister não está configurado. Algumas funcionalidades podem ser limitadas.",
        ...
        "Unnamed character": "Personagem sem nome",
        "Unnamed event": "Evento sem nome",
        "Welcome to Larpinq!": "Bem-vindo ao Larpinq!",
        "Configure your Larpinq settings here.": "Configure aqui as definições do Larpinq.",
        ...
        "Version Information": "Informações da versão",
        "Check-in": "Registo de entrada",
        "Attendance": "Presença",
        "Check in": "Registar entrada",
        "No-show": "Não compareceu",
        "Registered": "Inscrito",
        "Checked in": "Presente",
        "No confirmed participants for this event yet.": "Ainda não há participantes confirmados para este evento.",
        "Attendance tracking is unavailable — showing the participant list read-only.": "O registo de presenças não está disponível — a lista de participantes é apresentada apenas para leitura.",
        "Skill tree": "Árvore de habilidades",
        "No character (uncoloured)": "Sem personagem (sem cor)",
        "All worlds": "Todos os cenários",
        "Owned": "Adquirida",
        "Available": "Disponível",
        "Locked": "Bloqueada",
        "Unknown": "Desconhecida",
        "No skills to show": "Não há habilidades para mostrar",
        "No skills exist yet for the selected world.": "Ainda não existem habilidades para o cenário selecionado.",
        "Requires: {list}": "Requer: {list}",
        "No prerequisites": "Sem pré-requisitos",
        "Required skills": "Habilidades necessárias",
        "Required abilities": "Aptidões necessárias",
        "(score ≥ {n})": "(pontuação ≥ {n})",
        ...
        "Character roster": "Lista de personagens",
        "Progression": "Progressão",
        "World content": "Conteúdo do mundo",
        "Awaiting approval": "A aguardar aprovação",
        "Player characters": "Personagens de jogador",
        "Awards": "Atribuições",
        "Experience": "Experiência",
        "Experience awarded": "Experiência atribuída",
        "Per character": "Por personagem",
        "By type": "Por tipo",
        "By approval": "Por aprovação",
        "Items carried by characters": "Itens levados pelas personagens",
        "Conditions on characters": "Estados nas personagens",
        "Nothing awarded yet": "Ainda nada atribuído",
        "Who is playing what, and what is still waiting for approval.": "Quem joga o quê, e o que ainda aguarda aprovação.",
