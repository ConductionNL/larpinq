...
<template>
	<NcDialog v-if="navigationStore.dialog === 'deleteSkill'"
		name="Vaardigheid verwijderen"
		size="normal"
		:can-close="false">

		<p v-if="!success">
			Wil je <b>{{ skillStore.skillItem.name }}</b> definitief verwijderen? Deze actie kan niet ongedaan worden gemaakt.
		</p>
