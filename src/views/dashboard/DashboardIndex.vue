<template>
	<div>
		<CnDashboardPage
			...
			<!-- Skill Usage Chart widget -->
			<template #widget-skill-usage>
				<SkillUsageChart />
			</template>
		</CnDashboardPage>
...
import SkillUsageChart from './SkillUsageChart.vue'
...
const DEFAULT_LAYOUT = [
	...
	{ id: 7, widgetId: 'skill-usage', gridX: 0, gridY: 6, gridWidth: 6, gridHeight: 5 },
]
